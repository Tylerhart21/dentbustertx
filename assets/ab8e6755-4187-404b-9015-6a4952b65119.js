...
const DETAILED_SERVICES = [{
  ...
  blurb: "Texas hailstorms hit hard. Our PDR technicians have repaired thousands of vehicles after every major storm since 2014 — back to factory condition without touching your paint.",
  bullets: ["Massage-out technique — no filler, no paint", "Lifetime warranty on every dent", "Direct insurance coordination", "Free pickup and delivery across DFW", "Most claims close in under 14 days"],
  ...
  headline: "Detailed like it's ours.",
  blurb: "Interior and exterior detailing — vacuum, steam, shampoo, hand wash, clay bar, and sealant. Pick a package or build your own with add-ons.",
  bullets: ["Interior & exterior packages", "Steam and hot-water extraction", "Hand wash, clay bar & sealant", "Priced by vehicle size"],
  price: "Interior from $100 · Exterior from $65",
  accent: "#3b82f6"
}, {
  id: "tint",
  ...
  headline: "Cooler cabin. Cleaner look.",
  blurb: "Professional window film that blocks heat and UV, kills glare, and adds privacy — installed clean, with no bubbles, and backed for life.",
  bullets: ["Heat and UV rejection", "Glare reduction and privacy", "Ceramic and standard films", "Lifetime film warranty"],
  price: "Quoted by vehicle & film",
  accent: "#0ea5e9"
}, {
  id: "ppf",
  ...
  headline: "An invisible shield for your paint.",
  blurb: "Thick, self-healing urethane film over your most vulnerable panels — rock chips, sand, and scratches stop at the film, not your paint.",
  bullets: ["Self-healing clear film", "Front-end and full-body coverage", "Blocks rock chips & road debris", "Multi-year warranty"],
  price: "Quoted by coverage area",
  accent: "#22c55e"
}, {
  id: "wraps",
  ...
  headline: "Turn heads — or turn a profit.",
  blurb: "Full and partial custom wraps for commercial fleets, trailers, vans, and personal vehicles — designed, printed, and installed in-house.",
  bullets: ["Commercial fleet & trailer wraps", "Color-change and partial wraps", "Designed and printed in-house", "Clean, warrantied install"],
  price: "Quoted by vehicle & design",
  accent: "#f97316"
}, {
  id: "correction",
  ...
  headline: "Bring back the depth and gloss.",
  blurb: "Multi-stage machine polishing that removes swirls, scratches, and oxidation — restoring a deep, mirror-like finish before coating or sealing.",
  bullets: ["Removes swirls & light scratches", "1- and 2-stage correction", "Perfect prep for ceramic or sealant", "Show-quality gloss"],
  price: "Quoted by paint condition",
  accent: "#a855f7"
}, {
  id: "powder",
  ...
  headline: "A finish that fights back.",
  blurb: "Durable, chip- and corrosion-resistant powder coating for wheels, brackets, bumpers, and trim — baked on for a finish far tougher than paint.",
  bullets: ["Wheels, trim & hardware", "Chip- and rust-resistant", "Huge color & texture range", "Baked-on durability"],
  price: "Quoted by piece count",
  accent: "#eab308"
}];
function ServicesPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    sub: "From invisible hail repair to full custom wraps — detailing, window tint, paint protection, correction, and powder coating, all done in-house in McKinney."
    ...
    return /*#__PURE__*/React.createElement(FadeIn, {
      ...
      onClick: () => setPage(s.page || "contact")
    }, s.page ? "Learn more" : "Book this service", " ", /*#__PURE__*/React.createElement(ArrowRight, {
      size: 15
    }))))));
